...
def parse_option():
    ...
    parser.add_argument('--model_s', type=str, default='resnet8',
                        choices=['resnet8', 'resnet14', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet110',
                                 ...
                                 'MobileNetV2', 'ShuffleV1', 'ShuffleV2', 'clip_vanilla'])
...
def main():
    ...
    clip_preprocess = {}
    if opt.model_t == "clip":
        model_t, preprocess = clip.load('ViT-L/14@336px', device)
    ...
    teacher_acc, _, _ = validate(val_loader, model_t, criterion_cls, opt, clip_preprocess, False)
